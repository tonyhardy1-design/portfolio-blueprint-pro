      ...
      <section className="pt-32 pb-24 px-6">
        <div className="container mx-auto max-w-5xl">
          ...
          >
            ...
            <h1 className="font-display text-6xl md:text-8xl lg:text-[10rem] text-foreground leading-[0.85] -ml-1">
              Tony<br />
              <span className="italic text-muted-foreground">Hardy</span>
            </h1>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            >
              <h2 className="font-display text-3xl md:text-4xl text-foreground leading-tight">
                ...
                <span className="italic text-muted-foreground block">without colour</span>
              </h2>
