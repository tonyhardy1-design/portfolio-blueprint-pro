...
import crossroads from "@/assets/street/DSC02202.JPG";
...
export const streetImages = [
  ...
  { src: tram,       alt: "Passengers on a tram, city streets beyond",                         title: "Tram"       },
  { src: crossroads, alt: "Pedestrians at a city crossroads",                                  title: "Crossroads" },
  { src: market,     alt: "Movement through a street market",                                  title: "Market"     },
  { src: queue,      alt: "People waiting in a city queue",                                    title: "Queue"      },
  { src: undercroft, alt: "Figure beneath a city underpass",                                   title: "Undercroft" },
  { src: rush,       alt: "Rush hour on a city street",                                        title: "Rush"       },
  { src: plaza,      alt: "Wide city plaza, small figures",                                    title: "Plaza"      },
  { src: steps,      alt: "Figures descending city steps",                                     title: "Steps"      },
  { src: overpass,   alt: "View from an urban overpass",                                       title: "Overpass"   },
];
