...
export const streetImages = [
  ...
  { src: transit,    alt: "Figures seen through a passing train window",                       title: "Motion"     },
  { src: frequency,  alt: "Woman with headphones facing a large billboard",                    title: "Frequency"  },
  { src: sunday,     alt: "Candy floss stall on the Southbank on a summer evening",            title: "Southbank"  },
  { src: franks,     alt: "Families eating at Frank's Hot Dogs diner",                         title: "Frank!"     },
  { src: pier,       alt: "Two people relaxing in deckchairs on Brighton Pier",                title: "Resting"    },
  { src: tram,       alt: "Passengers on a tram, city streets beyond",                         title: "Outlook"    },
  { src: market,     alt: "Movement through a street market",                                  title: "Seated"     },
  { src: queue,      alt: "People waiting in a city queue",                                    title: "Waiting"    },
  { src: undercroft, alt: "Figure beneath a city underpass",                                   title: "Chilling"   },
  { src: rush,       alt: "Rush hour on a city street",                                        title: "Commute"    },
  { src: plaza,      alt: "Wide city plaza, small figures",                                    title: "Alone"      },
  { src: steps,      alt: "Figures descending city steps",                                     title: "Steps"      },
